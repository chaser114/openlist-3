;(() => {
  ...
  var e,
    ...
    t = {
      ...
      124: (e, n, t) => {
        e.exports = t.p + "42e3aa343876f01186be.wasm"
      },
      125: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 })
      },
      ...
      797: (e, n, t) => {
        e.exports = t.p + "a6983d7eb35df8ac3da5.wasm"
      },
      836: (e, n) => {
        Object.defineProperty(n, "__esModule", { value: !0 })
      },
  ...
  ;(r.m = t),
    ...
    (r.u = (e) =>
      "core.ruffle." +
      { 482: "2a82513640065271d398", 655: "ba3056949564bd8ca26c" }[e] +
      ".js"),
    (r.g = (function () {
  ...
  const l = {
    versionNumber: "0.1.0",
    versionName: "0.1.0 nightly 2025-06-19",
    versionChannel: "nightly",
    buildDate: "2025-06-19T00:07:17.474Z",
    commitHash: "dc22b9916f2003b320e692ff8581f0c084b89f94",
  }
  var u
  !(function (e) {
  ...
  class C extends z {
    static supportsValue(e) {
      ...
      if (e instanceof z) return C.supportsValue(e.valueOf())
  ...
  function A(e, n, t) {
    ...
    if (n instanceof S && "string" == typeof t) {
  ...
  function E(e, n, t) {
    return n[t]
      ? D(e, n[t].value)
      : (e.reportError(new RangeError("No default")), new j())
  }
  function q(e, n) {
    const t = [],
  ...
  function F(e, n) {
    switch (n.type) {
      case "str":
        return n.value
      case "num":
        return new S(n.value, { minimumFractionDigits: n.precision })
      case "var":
        return (function (e, { name: n }) {
          ...
          switch (typeof t) {
            ...
            case "number":
              return new S(t)
            case "object":
              if (C.supportsValue(t)) return new C(t)
            default:
              return (
                e.reportError(
                  new TypeError(
      ...
      case "mesg":
        return (function (e, { name: n, attr: t }) {
          ...
          if (a.value) return D(e, a.value)
          return e.reportError(new ReferenceError(`No value: ${n}`)), new j(n)
        })(e, n)
      case "term":
        return (function (e, { name: n, attr: t, args: a }) {
          ...
          if (!o)
            return (
              e.reportError(new ReferenceError(`Unknown term: ${r}`)), new j(r)
            )
          if (t) {
      ...
      case "func":
        return (function (e, { name: n, args: t }) {
          ...
          try {
            ...
            return e.reportError(t), new j(`${n}()`)
          }
        })(e, n)
      case "select":
        return (function (e, { selector: n, variants: t, star: a }) {
          let r = F(e, n)
          if (r instanceof j) return E(e, t, a)
          for (const n of t) {
            if (A(e, r, F(e, n.key))) return D(e, n.value)
          }
          return E(e, t, a)
        })(e, n)
      default:
  ...
  function P(e, n) {
    if (e.dirty.has(n))
      return e.reportError(new RangeError("Cyclic reference")), new j()
    e.dirty.add(n)
    const t = [],
    ...
    for (const r of n)
      if ("string" != typeof r) {
        ...
        a && t.push("\u2068"),
          t.push(F(e, r).toString(e)),
          a && t.push("\u2069")
      } else t.push(e.bundle._transform(r))
    return e.dirty.delete(n), t.join("")
  }
  function D(e, n) {
    return "string" == typeof n ? e.bundle._transform(n) : P(e, n)
  }
  class M {
    constructor(e, n, t) {
  ...
  function I(e, n) {
    let t = e[0]
    if (t instanceof j) return new j(`NUMBER(${t.valueOf()})`)
    if (t instanceof S) return new S(t.valueOf(), { ...t.opts, ...$(n, O) })
    if (t instanceof C) return new S(t.toNumber(), { ...$(n, O) })
  ...
  function W(e, n) {
    let t = e[0]
    if (t instanceof j) return new j(`DATETIME(${t.valueOf()})`)
    if (t instanceof C || t instanceof S) return new C(t, $(n, T))
  ...
  class N {
    ...
    formatPattern(e, n = null, t = null) {
      ...
      let a = new M(this, t, n)
      try {
        return P(a, e).toString(a)
      } catch (e) {
        if (a.errors && e instanceof Error)
          return a.errors.push(e), new j().toString(a)
        throw e
      }
    }
  }
  ...
  function Re() {
    ;("function" == typeof Array.prototype.reduce &&
      ...
      ("function" == typeof Window && ye(Window)) ||
  ...
  for (const [e, n] of Object.entries(xe)) {
    ...
    if (n) {
      ...
      for (const [r, o] of Object.entries(n))
        if (o) {
          a ??= we()
          for (const n of t.addResource(new fe(o)))
  ...
  function Se(e, n) {
    const t = we(),
      a = be(navigator.languages, Object.keys(ze), { defaultLocale: "en-US" })
    for (const t in a) {
      const r = je(a[t], e, n)
      if (r) return r
    }
    return console.error(`Unknown text key '${e}'`), ke(t), e
  }
  function Ce(e, n) {
  ...
  const Ae = navigator.userAgent.includes("Mac OS X") ? "Command" : "Ctrl"
  ...
  Ee.content.appendChild(
    ...
    Ee.content.appendChild(
      (0, R.jsx)(function () {
        return (0, R.jsx)("style", { id: "dynamic-styles" })
      }, {}),
    ),
    Ee.content.appendChild(
      (0, R.jsx)(function () {
      ...
      (0, R.jsx)(function () {
        return (0, R.jsxs)("div", {
          ...
          children: [
            ...
            (0, R.jsx)("div", {
              class: "loadbar",
              children: (0, R.jsx)("div", { class: "loadbar-inner" }),
            }),
          ],
        })
      }, {}),
      ...
      (0, R.jsx)(function () {
        return (0, R.jsx)("div", {
          ...
          children: (0, R.jsxs)("div", {
            ...
            class: "modal-area",
            children: [
              (0, R.jsx)("span", { class: "close-modal" }),
              (0, R.jsx)("div", {
                class: "general-save-options",
                children: (0, R.jsx)("span", { class: "modal-button" }),
              }),
              (0, R.jsx)("table", { id: "local-saves" }),
            ],
          }),
        })
      }, {}),
        ...
        return (0, R.jsx)("div", {
          ...
          children: (0, R.jsx)("div", {
            ...
            children: (0, R.jsxs)("div", {
              id: "volume-controls",
              children: [
                (0, R.jsx)("input", { id: "mute-checkbox", type: "checkbox" }),
                (0, R.jsx)("label", {
                  id: "volume-mute",
                  for: "mute-checkbox",
                  title: Se("volume-controls-unmute"),
                }),
                (0, R.jsx)("label", {
                  id: "volume-min",
                  for: "mute-checkbox",
                  title: Se("volume-controls-mute"),
                }),
                (0, R.jsx)("label", {
                  id: "volume-mid",
                  for: "mute-checkbox",
                ...
                (0, R.jsx)("span", { id: "volume-slider-text" }),
                (0, R.jsx)("span", { class: "close-modal" }),
              ],
            }),
          }),
      ...
      (0, R.jsx)(function () {
        return (0, R.jsx)("div", {
          ...
          children: (0, R.jsxs)("div", {
            ...
            children: [
              (0, R.jsx)("span", { class: "close-modal" }),
              (0, R.jsx)("h2", { children: Se("clipboard-message-title") }),
              (0, R.jsx)("p", { id: "clipboard-modal-description" }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ae, "+C"] }),
                  (0, R.jsx)("span", {
                    children: Se("clipboard-message-copy"),
                  }),
                ],
              }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ae, "+X"] }),
                  (0, R.jsx)("span", { children: Se("clipboard-message-cut") }),
                ],
              }),
              (0, R.jsxs)("p", {
                children: [
                  (0, R.jsxs)("b", { children: [Ae, "+V"] }),
                  (0, R.jsx)("span", {
                    children: Se("clipboard-message-paste"),
                  }),
                ],
              }),
            ],
    ...
    Ee.content.appendChild(
      (0, R.jsx)(function () {
        return (0, R.jsx)("div", {
          ...
          class: "hidden",
          children: (0, R.jsx)("ul", { id: "context-menu" }),
        })
      }, {}),
    )
  const qe = "application/x-shockwave-flash",
    Fe = "application/futuresplash",
    Pe = "application/x-shockwave-flash2-preview",
    De = "application/vnd.adobe.flash.movie"
  function Me(e, n) {
    const t = (function (e) {
      let n = ""
      try {
  ...
  try {
    if (
      ...
      e.endsWith(".js") || e.endsWith("/") || (e += "/"),
        ($e = new URL(".", e)),
        (Oe = $e.protocol.includes("extension"))
    }
  } catch (e) {
  ...
  const Be = {
    OpenDemo: {
      type: "open_link",
      url: Ie + "/demo",
      label: Se("ruffle-demo"),
    },
    DownloadDesktop: {
      type: "open_link",
      url: Ie + "/downloads#desktop-app",
      label: Se("ruffle-desktop"),
    },
    UpdateRuffle: {
      type: "open_link",
      url: Ie + "/downloads",
      label: Se("update-ruffle"),
    },
    CreateReport: { type: "create_report" },
    ShowDetails: { type: "show_details" },
    createReportOrUpdate() {
      return Ue() ? this.UpdateRuffle : this.CreateReport
    },
    openWiki: (e, n) => ({
      type: "open_link",
      url: `https://github.com/ruffle-rs/ruffle/wiki/${e}`,
      label: n ?? Se("ruffle-wiki"),
    }),
  }
  function Ve(e, n, t, a) {
    const r = t.join(""),
      { body: o, actions: i } = (function (e) {
        if (e instanceof Te)
          return e.swfUrl && !e.swfUrl.protocol.includes("http")
            ? {
                body: Ce("error-file-protocol"),
                actions: [Be.OpenDemo, Be.DownloadDesktop],
              }
            : window.location.origin === e.swfUrl?.origin ||
                window.location.protocol.includes("extension")
              ? { body: Ce("error-swf-fetch"), actions: [Be.ShowDetails] }
              : {
                  body: Ce("error-swf-cors"),
                  actions: [
                    Be.openWiki("Using-Ruffle#configure-cors-header"),
                    Be.ShowDetails,
                  ],
                }
        if (e instanceof We)
          return { body: Ce("error-invalid-swf"), actions: [Be.ShowDetails] }
        if (e instanceof Le) {
          ...
          if (n.includes("mime"))
            return {
              body: Ce("error-wasm-mime-type"),
              actions: [
                Be.openWiki("Using-Ruffle#configure-webassembly-mime-type"),
                Be.ShowDetails,
              ],
            }
          if (
          ...
          if (n.includes("disallowed by embedder"))
            return {
              body: Ce("error-csp-conflict"),
              actions: [
                Be.openWiki("Using-Ruffle#configure-wasm-csp"),
                Be.ShowDetails,
              ],
            }
          if ("CompileError" === e.cause.name && n.includes("bad type"))
            return {
              body: Ce("error-wasm-unsupported-browser"),
              actions: [Be.openWiki("#web"), Be.ShowDetails],
            }
          if ("CompileError" === e.cause.name)
            return {
              body: Ce("error-wasm-invalid"),
              actions: [
          ...
          if (
            ...
            return {
              body: Ce("error-wasm-download"),
              actions: [Be.ShowDetails],
            }
          if ("TypeError" === e.cause.name) {
            const e = Ce("error-javascript-conflict")
            return (
              Ue() &&
                e.appendChild(
                  Ce("error-javascript-conflict-outdated", {
                    buildDate: l.buildDate,
                  }),
                ),
              { body: e, actions: [Be.createReportOrUpdate(), Be.ShowDetails] }
            )
          }
          return navigator.userAgent.includes("Edg") &&
            n.includes("webassembly is not defined")
            ? {
                body: Ce("error-wasm-disabled-on-edge"),
                actions: [
                  Be.openWiki(
            ...
            : {
                body: Ce("error-wasm-not-found"),
                actions: [
                  Be.openWiki("Using-Ruffle#configuration-options"),
                  Be.ShowDetails,
                ],
              }
        }
        return e instanceof Ne
          ? {
              body: Ce("error-javascript-config"),
              actions: [
                Be.openWiki("Using-Ruffle#javascript-api"),
                Be.ShowDetails,
              ],
            }
          : {
              body: Ce("error-unknown", {
                buildDate: l.buildDate,
                outdated: String(Ue),
              }),
              actions: [Be.createReportOrUpdate(), Be.ShowDetails],
            }
      })(n),
      s = (0, _e.createRef)(),
      u = () => {
        s.current.classList.add("details"),
          s.current.replaceChildren(
            (0, R.jsx)("textarea", { readOnly: !0, children: r }),
          )
      }
    ;(e.textContent = ""),
      e.appendChild(
        (0, R.jsxs)("div", {
          ...
          children: [
            (0, R.jsx)("div", {
              id: "panic-title",
              children: Se("panic-title"),
            }),
            (0, R.jsx)("div", { id: "panic-body", ref: s, children: o }),
            (0, R.jsx)("div", {
              id: "panic-footer",
              children: (0, R.jsx)("ul", {
                children: i.map((e) =>
                    ...
                    if ("show_details" === e.type) {
                      ...
                      return (0, R.jsx)("li", {
                        children: (0, R.jsx)("a", {
                          ...
                          onClick: e,
                          children: Se("view-error-details"),
                        }),
                      })
                    }
                    if ("open_link" === e.type)
  ...
  async function Ye(e) {
    null === Ge &&
      (Ge = (async function (e) {
        Re()
        const n = (await Promise.all([He(), Qe(), Ze(), Ke(), Je()])).every(
          Boolean,
        )
        n ||
          console.log(
      ...
      for (; a < 999; ) {
        ...
        if (
          ...
          return (
            ...
            (Xe[e] = { class: n, name: t, internalName: e }),
            t
          )
        a += 1
      }
  ...
  function tn(e, n) {
    if (
      (nn(n.allowScriptAccess) && e.setAllowScriptAccess(n.allowScriptAccess),
      nn(n.backgroundColor) &&
      ...
      nn(n.upgradeToHttps) && e.setUpgradeToHttps(n.upgradeToHttps),
      nn(n.compatibilityRules) && e.setCompatibilityRules(n.compatibilityRules),
      nn(n.letterbox) && e.setLetterbox(n.letterbox.toLowerCase()),
      nn(n.base) && e.setBaseUrl(n.base),
      nn(n.menu) && e.setShowMenu(n.menu),
      nn(n.allowFullscreen) && e.setAllowFullscreen(n.allowFullscreen),
      nn(n.salign) && e.setStageAlign(n.salign.toLowerCase()),
      nn(n.forceAlign) && e.setForceAlign(n.forceAlign),
      nn(n.quality)
        ...
        : void 0 !== window.orientation &&
          ...
          e.setQuality("low")),
      nn(n.scale) && e.setScale(n.scale.toLowerCase()),
      nn(n.forceScale) && e.setForceScale(n.forceScale),
      nn(n.frameRate) && e.setFrameRate(n.frameRate),
      nn(n.wmode) && e.setWmode(n.wmode),
      nn(n.logLevel) && e.setLogLevel(n.logLevel),
      nn(n.maxExecutionDuration) &&
      ...
      nn(n.playerVersion) && e.setPlayerVersion(n.playerVersion),
      nn(n.preferredRenderer) && e.setPreferredRenderer(n.preferredRenderer),
      nn(n.openUrlMode) && e.setOpenUrlMode(n.openUrlMode.toLowerCase()),
      nn(n.allowNetworking) &&
        e.setAllowNetworking(n.allowNetworking.toLowerCase()),
      nn(n.credentialAllowList) &&
        e.setCredentialAllowList(n.credentialAllowList),
      nn(n.playerRuntime) && e.setPlayerRuntime(n.playerRuntime),
      nn(n.socketProxy))
    )
      for (const t of n.socketProxy)
        e.addSocketProxy(t.host, t.port, t.proxyUrl)
    if (nn(n.gamepadButtonMapping))
      for (const [t, a] of Object.entries(n.gamepadButtonMapping))
        e.addGamepadButtonMapping(t, a)
    if (nn(n.urlRewriteRules))
    ...
    nn(n.scrollingBehavior) && e.setScrollingBehavior(n.scrollingBehavior)
  }
  const an = /^\s*(\d+(\.\d+)?(%)?)/
  let rn = !1
  function on(e) {
  ...
  class ln {
    constructor(e, n, t) {
      ;(this.contextMenuForceDisabled = !1),
        ...
        (this.SaveRow = ({ rowKey: e, solName: n, solData: t }) =>
          (0, R.jsxs)("tr", {
            children: [
              (0, R.jsx)("td", { title: e, children: n }),
              (0, R.jsx)("td", {
                children: (0, R.jsx)("span", {
                  class: "save-option",
                  id: "download-save",
                  title: Se("save-download"),
                  onClick: () =>
                    pn(
                      (function (e, n) {
                        const t = hn(e)
        ...
        (this.volumeSettings = new un(!1, 100)),
      ...
      a &&
        ...
        (a.innerText = Se("save-backup-all")))
      const r = this.unmuteOverlay.querySelector("#unmute-overlay-svg")
      if (r) {
        r.querySelector("#unmute-text").textContent = Se("click-to-unmute")
      }
    ...
    async ensureFreshInstance() {
      ...
      const [e, n] = await Ye(this.onRuffleDownloadProgress.bind(this)).catch(
        (e) => {
    ...
    async reloadWithCanvasRenderer() {
      if (
        ...
        if (!this.loadedConfig)
          throw new Error("Cannot reload if load wasn't first called")
        this.panic(new Error(Se("error-canvas-reload")))
      }
    }
    async load(e, n = !1) {
      if (
        ...
        if (!mn(this.element))
          try {
            ;(this.loadedConfig = {
              ...x,
              ...(n && "url" in e
                ? { allowScriptAccess: bn("samedomain", e.url) }
                : {}),
              ...
              "url" in e
                ? (console.log(`Loading SWF file ${e.url}`),
                  ...
                  this.instance.stream_from(this.swfUrl.href, on(e.parameters)))
                : "data" in e &&
    ...
    confirmReloadSave(e, n, t) {
      if (vn(n) && localStorage[e]) {
        if (!t) {
          if (!confirm(Se("save-delete-prompt"))) return
        }
        ...
        if (a.includes(o) && e.startsWith(r)) {
          return void (
            confirm(
              Se("save-reload-prompt", { action: t ? "replace" : "delete" }),
            ) &&
            this.loadedConfig &&
            (this.destroy(),
      ...
      ;(e.textContent = ""),
        Object.keys(localStorage).forEach((n) => {
          ...
          t &&
            ...
            vn(a) &&
            e.appendChild(
              (0, R.jsx)(this.SaveRow, { rowKey: n, solName: t, solData: a }),
            )
        })
    }
    async backupSaves() {
      ...
      pn(new Blob([e.save()], { type: "application/zip" }), "saves.zip")
    }
    ...
    contextMenuItems() {
      ...
      return (
        this.fullscreenEnabled &&
          (this.isFullscreen
            ? n.push({
                text: Se("context-menu-exit-fullscreen"),
                onClick: async () => this.setFullscreen(!1),
              })
            : n.push({
                text: Se("context-menu-enter-fullscreen"),
                onClick: async () => this.setFullscreen(!0),
              })),
        n.push({
          text: Se("context-menu-volume-controls"),
          onClick: async () => {
        ...
        this.instance &&
          ...
          (t(),
          n.push({
            text: Se("context-menu-download-swf"),
            onClick: this.downloadSwf.bind(this),
          })),
        navigator.clipboard &&
          window.isSecureContext &&
          n.push({
            text: Se("context-menu-copy-debug-info"),
            onClick: () => navigator.clipboard.writeText(this.getPanicData()),
          }),
        this.checkSaves() &&
          n.push({
            text: Se("context-menu-open-save-manager"),
            onClick: this.openSaveManager.bind(this),
          }),
        t(),
        n.push({
          text: Se("context-menu-about-ruffle", {
            flavor: Oe ? "extension" : "",
    ...
    pointerDown(e) {
      ;(this.pointerDownPosition = new sn(e.pageX, e.pageY)),
        (this.pointerMoveMaxDistance = 0),
    ...
    checkLongPressMovement(e) {
      if (null !== this.pointerDownPosition) {
        const n = new sn(e.pageX, e.pageY),
    ...
    panic(e) {
      ...
      t.push(this.getPanicData()),
        Ve(this.container, n, t, this.swfUrl),
        this.destroy()
    }
    addOpenInNewTabMessage(e, n) {
      const t = new URL(n)
      if (this.loadedConfig?.parameters) {
        const e = on(this.loadedConfig?.parameters)
      ...
      ;(r.className = "message"), r.appendChild(Ce("message-cant-embed"))
      const o = document.createElement("div"),
        i = document.createElement("a")
      ;(i.innerText = Se("open-in-new-tab")),
        (i.onclick = () => e(t)),
        o.appendChild(i),
        r.appendChild(o),
        a.appendChild(r),
    ...
    displayRootMovieDownloadFailedMessage(e) {
      ...
      if (n && this.swfUrl && window.location.origin !== this.swfUrl.origin)
        ...
        const n = e ? new We(this.swfUrl) : new Te(this.swfUrl)
        this.panic(n)
      }
    }
    displayMessageOrElement(e) {
      const n = (0, R.jsx)("div", {
        id: "message-overlay",
        children: (0, R.jsxs)("div", {
          class: "message",
          children: [
            e instanceof HTMLDivElement ? e : (0, R.jsx)("p", { children: e }),
            (0, R.jsx)("div", {
              children: (0, R.jsx)("button", {
                id: "continue-btn",
                children: Se("continue"),
              }),
            }),
          ],
        }),
    ...
    displayRestoredFromBfcacheMessage() {
      ...
      const e = Ce("message-restored-from-bfcache")
      this.displayMessageOrElement(e)
    ...
    displayClipboardModal(e) {
      ...
      n &&
        ((n.textContent = Se("clipboard-message-description", {
    ...
    setMetadata(e) {
      ;(this.metadata = e),
        ...
        this.hideSplashScreen(),
        this.element.dispatchEvent(new CustomEvent(ln.LOADED_METADATA)),
        this.element.dispatchEvent(new CustomEvent(ln.LOADED_DATA))
    }
  }
  ;(ln.LOADED_METADATA = "loadedmetadata"), (ln.LOADED_DATA = "loadeddata")
  class un {
    constructor(e, n) {
  ...
  function cn(e, n) {
    ...
    const r = bn(n("allowScriptAccess"), e)
  ...
  class Rn {
    constructor(e) {
      wn.set(this, void 0), kn(this, wn, e, "f")
    }
    addFSCommandHandler(e) {
      yn(this, wn, "f").addFSCommandHandler(e)
    }
    get readyState() {
    ...
    callExternalInterface(e, ...n) {
      return yn(this, wn, "f").callExternalInterface(e, n)
    }
  }
  wn = new WeakMap()
  var xn,
  ...
  class Cn extends HTMLElement {
    ...
    get readyState() {
      return jn(this, xn, "f")._readyState
    }
    get metadata() {
      return jn(this, xn, "f").metadata
    }
    constructor() {
      super(),
        xn.set(this, void 0),
            ...
            (e) => {
              try {
                Object.defineProperty(this, e, {
                  value: (...n) =>
                    jn(this, xn, "f").callExternalInterface(e, n),
                  configurable: !0,
                })
              } catch (n) {
                console.warn(
        ...
        jn(this, xn, "f").addFSCommandHandler((e, n) => {
          jn(this, zn, "f")?.call(this, e, n)
        })
    }
    ruffle(e) {
      if (1 === (e ?? 1)) return new Rn(jn(this, xn, "f"))
      throw new Error(`Version ${e} not supported.`)
    }
    get loadedConfig() {
      return jn(this, xn, "f").loadedConfig ?? null
    }
    connectedCallback() {
      jn(this, xn, "f").updateStyles()
    }
    static get observedAttributes() {
      return ["width", "height", "align"]
    }
    attributeChangedCallback(e, n, t) {
      Cn.observedAttributes.includes(e) && jn(this, xn, "f").updateStyles()
    }
    disconnectedCallback() {
      jn(this, xn, "f").destroy()
    }
    async reload() {
      await jn(this, xn, "f").reload()
    }
    async load(e, n = !1) {
      await jn(this, xn, "f").load(e, n)
    }
    play() {
      jn(this, xn, "f").play()
    }
    get isPlaying() {
      return jn(this, xn, "f").isPlaying
    }
    get volume() {
      return jn(this, xn, "f").volume
    }
    set volume(e) {
      jn(this, xn, "f").volume = e
    }
    get fullscreenEnabled() {
      return jn(this, xn, "f").fullscreenEnabled
    }
    get isFullscreen() {
      return jn(this, xn, "f").isFullscreen
    }
    setFullscreen(e) {
      jn(this, xn, "f").setFullscreen(e)
    }
    enterFullscreen() {
      jn(this, xn, "f").enterFullscreen()
    }
    exitFullscreen() {
      jn(this, xn, "f").exitFullscreen()
    }
    async downloadSwf() {
      await jn(this, xn, "f").downloadSwf()
    }
    pause() {
      jn(this, xn, "f").pause()
    }
    set traceObserver(e) {
      jn(this, xn, "f").traceObserver = e
    }
    debugPlayerInfo() {
      return ""
    }
    PercentLoaded() {
      return jn(this, xn, "f")._readyState === u.Loaded ? 100 : 0
    }
    get config() {
      return jn(this, xn, "f").config
    }
    set config(e) {
      jn(this, xn, "f").config = e
    }
    displayMessage(e) {
      jn(this, xn, "f").displayMessage(e)
    }
  }
  function An(e, n) {
    if (e) {
  ...
  class En extends Cn {
    ...
    static get observedAttributes() {
      return [...Cn.observedAttributes, "src"]
    }
    attributeChangedCallback(e, n, t) {
      if (
    ...
    static isInterdictable(e) {
      ...
      return !!n && !mn(e) && (dn(n) ? (fn(e, "src"), !1) : Me(n, t))
    }
    static fromNativeEmbedElement(e) {
      const n = en("ruffle-embed", En),
  ...
  class _n {
    ...
    install(e) {
      const n = new Un(e),
        t = Nn(this, Pn, "f").length
      Nn(this, Pn, "f").push(n),
        (Nn(this, Dn, "f")[e.type] = n),
    ...
    item(e) {
      return Nn(this, Pn, "f")[e >>> 0]
    }
    namedItem(e) {
      return Nn(this, Dn, "f")[e]
    }
    get length() {
      return Nn(this, Pn, "f").length
    }
    [((Pn = new WeakMap()), (Dn = new WeakMap()), Symbol.iterator)]() {
      return Nn(this, Pn, "f")[Symbol.iterator]()
    }
  ...
  class Un {
    constructor(e) {
      Mn.set(this, void 0), Ln(this, Mn, e, "f")
    }
    get type() {
      return Nn(this, Mn, "f").type
    }
    get description() {
      return Nn(this, Mn, "f").description
    }
    get suffixes() {
      return Nn(this, Mn, "f").suffixes
    }
    get enabledPlugin() {
      return Nn(this, Mn, "f").enabledPlugin
    }
    get [((Mn = new WeakMap()), Symbol.toStringTag)]() {
      return "MimeType"
    }
  }
  class Bn extends _n {
  ...
  class Vn {
    ...
    install(e) {
      const n = Nn(this, Tn, "f").length
      Nn(this, Tn, "f").push(e),
        (Nn(this, Wn, "f")[e.name] = e),
    ...
    item(e) {
      return Nn(this, Tn, "f")[e >>> 0]
    }
    namedItem(e) {
      return Nn(this, Wn, "f")[e]
    }
    refresh() {}
    [((Tn = new WeakMap()), (Wn = new WeakMap()), Symbol.iterator)]() {
      return Nn(this, Tn, "f")[Symbol.iterator]()
    }
    get [Symbol.toStringTag]() {
      return "PluginArray"
    }
    get length() {
      return Nn(this, Tn, "f").length
    }
  }
  const Hn = new Bn("Shockwave Flash", "Shockwave Flash 32.0 r0", "ruffle.js")
  Hn.install({
    type: Fe,
  ...
  const Jn = window.RufflePlayer?.config ?? {},
    Zn =
      (function (e) {
        let n = $e?.href ?? ""
        return (
  ...
  function Xn() {
    try {
      ;(Kn = Kn ?? document.getElementsByTagName("object")),
        (Qn = Qn ?? document.getElementsByTagName("embed"))
      for (const e of Array.from(Kn))
        if (Fn.isInterdictable(e)) {
          const n = Fn.fromNativeObjectElement(e)
          e.replaceWith(n)
        }
  ...
  function et() {
    ;(Gn = Gn ?? document.getElementsByTagName("iframe")),
      (Yn = Yn ?? document.getElementsByTagName("frame")),
      [Gn, Yn].forEach((e) => {
        for (const n of e) {
  ...
  async function nt(e, n) {
    ...
    try {
      ...
      return void (Oe || console.warn(n + e))
    }
    if (Oe || void 0 === t.documentElement.dataset.ruffleOptout)
      if (Oe)
        e.RufflePlayer || (e.RufflePlayer = {}),
          (e.RufflePlayer.config = { ...Jn, ...(e.RufflePlayer.config ?? {}) })
      else if (!e.RufflePlayer) {
        const n = t.createElement("script")
        n.setAttribute("src", Zn),
          (n.onload = () => {
            ;(e.RufflePlayer = {}), (e.RufflePlayer.config = Jn)
          }),
  ...
  function tt() {
    !(function (e) {
      ...
      ;("install" in navigator.plugins && navigator.plugins.install) ||
        (Object.defineProperty(window, "PluginArray", { value: Vn }),
        Object.defineProperty(navigator, "plugins", {
          value: new Vn(navigator.plugins),
          writable: !1,
        })),
        ...
        !(e.length > 0) ||
          ...
          Object.defineProperty(window, "MimeType", { value: Un }),
  ...
  function at() {
    ;(("favorFlash" in Jn && !1 === Jn.favorFlash) ||
      "ruffle.js" ===
  ...
  try {
    if (
      ...
      let e = document.currentScript.src
      e.endsWith(".js") || e.endsWith("/") || (e += "/"), (ot = new URL(".", e))
    }
  } catch (e) {
    console.warn("Unable to get currentScript URL", e)
  }
